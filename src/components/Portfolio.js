    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>A mashup of different simple to complex websites and webapps. built with programming stacks for the front and backend </p>
        </div>
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">Reactjs</li>
              <li data-filter=".filter-web">Nodejs</li>
              <li data-filter=".filter-web">React Native</li>
              <li data-filter=".filter-web">Fullstack</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/tech-pic.png" class="img-fluid" alt="" />
              <div class="portfolio-links">
                <a href="assets/img/portfolio/portfolio-1.jpg" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="bx bx-plus"></i></a>
                <a href="http://ec2-3-14-3-40.us-east-2.compute.amazonaws.com" target="_blank" >Live Project</a>
              </div>
